...
export const GeminiLayout: FC<{
  ...
  <CollapsibleSidebarLayout
    ...
    shellClassName="bg-[#fdfcfc] text-[#1f1f1f] dark:bg-[#0c0c0c] dark:text-[#e3e3e3]"
    sidebarBorderClassName="border-[#dadce0] dark:border-[#3c4043]"
    sheetClassName="border-[#dadce0] bg-[#fdfcfc] text-[#1f1f1f] dark:border-[#3c4043] dark:bg-[#0c0c0c] dark:text-[#e3e3e3]"
