...
export const GrokThreadList: FC = () => {
    ...
    <ThreadListPrimitive.Root className="aui-root aui-thread-list-root flex flex-col gap-1">
      <ThreadListPrimitive.New asChild>
        <Button
          variant="outline"
          onClick={onNewClick}
          className="aui-thread-list-new h-9 justify-start gap-2 rounded-lg border-[#e5e5e5] bg-transparent px-3 text-[#0d0d0d] text-sm hover:bg-[#f0f0f0] dark:border-[#2a2a2a] dark:text-white dark:hover:bg-[#2a2a2a]"
        >
...
const GrokThreadListItem: FC = () => (
  <ThreadListItemLastActivityTooltip>
    <ThreadListItemPrimitive.Root className="group flex h-9 items-center gap-2 rounded-lg transition-colors hover:bg-[#f0f0f0] data-active:bg-[#f0f0f0] dark:hover:bg-[#2a2a2a] dark:data-active:bg-[#2a2a2a]">
      <ThreadListItemNavTrigger className="flex h-full min-w-0 flex-1 items-center px-3 text-start text-[#0d0d0d] text-sm dark:text-white">
        <ThreadListItemTitle />
      </ThreadListItemNavTrigger>
